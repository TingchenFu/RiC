...
CUDA_VISIBLE_DEVICES=2,3 torchrun --nproc_per_node=2 --master_port=1234  /home/futingchen/MultiContrast/RiC/ric/on_offline.py  \
    --model_name_or_path ${HOME}/PLM/${backbone} \
